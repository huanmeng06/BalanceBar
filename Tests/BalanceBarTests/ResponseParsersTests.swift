...
final class ResponseParsersTests: XCTestCase {
    ...
    func testOfficialQuotaFixturesCoverClaudeAndCodexWindows() throws {
        ...
        XCTAssertEqual(claude.label, tr("7 日额度", "7-Day Quota"))
        XCTAssertEqual(claude.daysText, tr("7 天", "7 Days"))
        ...
        XCTAssertEqual(codex.label, tr("7 日额度", "7-Day Quota"))
        XCTAssertEqual(codex.daysText, tr("7 天", "7 Days"))
