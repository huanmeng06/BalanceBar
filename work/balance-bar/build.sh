...
for resource_file in BalanceBar.icns GitHub.svg CodexIcon.svg Claude.svg ClaudeThinking.svg Grok.svg Grok.png GrokThinking.svg GrokThinking.png GrokThinking.gif
do
